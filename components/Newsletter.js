...
const Newsletter = () => {
  return (
    <div>
      <div className="relative isolate overflow-hidden bg-blue-200 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-[#285192] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Subscribe
              </button>
            </div>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dt className="mt-4 font-semibold text-black-900">Weekly articles</dt>
              <dd className="mt-2 leading-7 text-black-900">
